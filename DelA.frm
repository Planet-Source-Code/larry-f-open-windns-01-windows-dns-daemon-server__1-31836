VERSION 5.00
Begin VB.Form DelA 
   Caption         =   "Delete A-Record/ Sub-Domain"
   ClientHeight    =   3180
   ClientLeft      =   60
   ClientTop       =   360
   ClientWidth     =   4680
...
recordDNS.Open "DELETE * from " & List2.List(List1.ListIndex) & " WHERE Name='" & List4.List(List4.ListIndex) & "';", dataDNS, adOpenKeyset, adLockPessimistic, adCmdText
'recordDNS.Update
'recordDNS.Close
Unload Me
End Sub
